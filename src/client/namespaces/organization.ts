...
export function createOrganizationNamespace(
  ...
  return {
    ...
    deleteSpaceNote: (args) => call('organization.notes.deleteSpaceNote', args),
    getAllDeviceNotes: (args) => call('organization.notes.getAllDeviceNotes', args),
    getAllSpaceNotes: (args) => call('organization.notes.getAllSpaceNotes', args),
    getDeviceNotes: (args) => call('organization.notes.getDeviceNotes', args),
    getSpaceNotes: (args) => call('organization.notes.getSpaceNotes', args),
