(function () {
  ...
  function selectViewForTarget(target, focus) {
    if (!target || !target.classList || !target.classList.contains("guide-view")) return false;
    var viewName = target.getAttribute("data-view");
    var shell = target.closest(".guide-shell") || document;
    var article = target.closest(".article") || shell;
